...
async function Init() {
    ...
    sortDropdown.children[0].onclick = function () {
        ...
        aleaButton.onclick = function () {
            wasSetToAlea = true;
            document.getElementsByClassName("content-base content-common filter-item filter-game")[0].children[3].children[0].innerHTML = "<strong>Alea</strong>: This filter shows a random selection of games."
            ReplaceMoreButton();
            ReplaceGames();
